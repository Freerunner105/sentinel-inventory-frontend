...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URL', 'postgresql://localhost/jail_inventory').replace('postgres://', 'postgresql://')
...
bcrypt = Bcrypt(app)
jwt = JWTManager(app)
CORS(app, resources={r"/*": {"origins": "https://jail-inventory-frontend-56f05c1c005d.herokuapp.com"}}, supports_credentials=True)
